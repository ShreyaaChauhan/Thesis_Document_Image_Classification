...
- [ ] Complete Deep Learning using Pytorch Books **(working on it currently 328/1187)** ![](https://geps.dev/progress/28)
- [ ] Code refactoring
...
- [ ] Dig more into metrices for classification prepare notes
- [ ] Prepare notes on classification loss eg BCE, cross entropy
